...
function _create(body, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'api/organisations';
  ...
  try {
    if (body !== null && body !== undefined) {
      let requestModelMapper = new client.models['Organisation']().mapper();
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['Organisation']().mapper();
...
function _update(body, id, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'api/organisations/{id}';
...
/** Class representing a Organisations. */
class Organisations {
  /**
