...
function _create(body, id, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'api/Organisations/{id}/TermsAndConditions';
  ...
  try {
    if (body !== null && body !== undefined) {
      let requestModelMapper = new client.models['TermsAndConditions']().mapper();
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['TermsAndConditions']().mapper();
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'TermsAndConditionsElementType',
                  type: {
                    name: 'Composite',
...
/** Class representing a TermsAndConditionsOperations. */
class TermsAndConditionsOperations {
  /**
   * Create a TermsAndConditionsOperations.
...
module.exports = TermsAndConditionsOperations;
