 ...
 */
function _requestToken(body, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'api/authentication/request';
  ...
  try {
    if (body !== null && body !== undefined) {
      let requestModelMapper = new client.models['TokenRequest']().mapper();
...
class Authentication {
   ...
   */
  requestTokenWithHttpOperationResponse(body, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._requestToken(body, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  requestToken(body, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._requestToken(body, options, optionalCallback);
    }
  }
