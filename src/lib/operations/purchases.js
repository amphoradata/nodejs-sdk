 ...
 */
function _purchase(id, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'api/Amphorae/{id}/Purchases';
...
/** Class representing a Purchases. */
class Purchases {
  /**
   * Create a Purchases.
   ...
   */
  purchaseWithHttpOperationResponse(id, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._purchase(id, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  purchase(id, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._purchase(id, options, optionalCallback);
    }
  }
