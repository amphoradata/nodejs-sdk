...
export interface DetailedAmphora {
     ...
     * @memberof DetailedAmphora
     */
    fileAttributes?: { [key: string]: AttributeStore; } | null;
    /**
     * 
     * @type {string}
     * @memberof DetailedAmphora
...
export const AmphoraeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        amphoraeFilesListFiles(id: string, orderBy?: string, xAmphoradataVersion?: string, options: any = {}): RequestArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
         ...
         * @throws {RequiredError}
         */
        amphoraeFilesWriteFileMetadata(id: string, file: string, requestBody: { [key: string]: string; }, xAmphoradataVersion?: string, options: any = {}): RequestArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling amphoraeFilesWriteFileMetadata.');
            }
            // verify required parameter 'file' is not null or undefined
            if (file === null || file === undefined) {
                throw new RequiredError('file','Required parameter file was null or undefined when calling amphoraeFilesWriteFileMetadata.');
            }
            // verify required parameter 'requestBody' is not null or undefined
            if (requestBody === null || requestBody === undefined) {
                throw new RequiredError('requestBody','Required parameter requestBody was null or undefined when calling amphoraeFilesWriteFileMetadata.');
            }
            const localVarPath = `/api/amphorae/{id}/files/{file}/meta`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)))
                .replace(`{${"file"}}`, encodeURIComponent(String(file)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        amphoraeSignalsCreateSignal(id: string, signal: Signal, xAmphoradataVersion?: string, options: any = {}): RequestArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
            ...
            if (signal === null || signal === undefined) {
                throw new RequiredError('signal','Required parameter signal was null or undefined when calling amphoraeSignalsCreateSignal.');
            }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...options.headers};
            const needsSerialization = (typeof signal !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
export const AmphoraeApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        amphoraeFilesListFiles(id: string, orderBy?: string, xAmphoradataVersion?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>> {
            const localVarAxiosArgs = AmphoraeApiAxiosParamCreator(configuration).amphoraeFilesListFiles(id, orderBy, xAmphoradataVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        amphoraeFilesWriteFileMetadata(id: string, file: string, requestBody: { [key: string]: string; }, xAmphoradataVersion?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: string; }> {
            const localVarAxiosArgs = AmphoraeApiAxiosParamCreator(configuration).amphoraeFilesWriteFileMetadata(id, file, requestBody, xAmphoradataVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        amphoraeSignalsCreateSignal(id: string, signal: Signal, xAmphoradataVersion?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Signal> {
            const localVarAxiosArgs = AmphoraeApiAxiosParamCreator(configuration).amphoraeSignalsCreateSignal(id, signal, xAmphoradataVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const AmphoraeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        amphoraeFilesListFiles(id: string, orderBy?: string, xAmphoradataVersion?: string, options?: any) {
         ...
         * @throws {RequiredError}
         */
        amphoraeFilesWriteFileMetadata(id: string, file: string, requestBody: { [key: string]: string; }, xAmphoradataVersion?: string, options?: any) {
         ...
         * @throws {RequiredError}
         */
        amphoraeSignalsCreateSignal(id: string, signal: Signal, xAmphoradataVersion?: string, options?: any) {
...
export class AmphoraeApi extends BaseAPI {
     ...
     * @memberof AmphoraeApi
     */
    public amphoraeFilesListFiles(id: string, orderBy?: string, xAmphoradataVersion?: string, options?: any) {
     ...
     * @memberof AmphoraeApi
     */
    public amphoraeFilesWriteFileMetadata(id: string, file: string, requestBody: { [key: string]: string; }, xAmphoradataVersion?: string, options?: any) {
     ...
     * @memberof AmphoraeApi
     */
    public amphoraeSignalsCreateSignal(id: string, signal: Signal, xAmphoradataVersion?: string, options?: any) {
...
export const MarketApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        marketFind(query?: string, top?: number, skip?: number, xAmphoradataVersion?: string, options: any = {}): RequestArgs {
            const localVarPath = `/api/market/search`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @throws {RequiredError}
         */
        marketLookupLocation(query?: string, xAmphoradataVersion?: string, options: any = {}): RequestArgs {
            const localVarPath = `/api/location/fuzzy`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const MarketApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        marketFind(query?: string, top?: number, skip?: number, xAmphoradataVersion?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<BasicAmphora>> {
            const localVarAxiosArgs = MarketApiAxiosParamCreator(configuration).marketFind(query, top, skip, xAmphoradataVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        marketLookupLocation(query?: string, xAmphoradataVersion?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FuzzySearchResponse> {
            const localVarAxiosArgs = MarketApiAxiosParamCreator(configuration).marketLookupLocation(query, xAmphoradataVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const MarketApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        marketFind(query?: string, top?: number, skip?: number, xAmphoradataVersion?: string, options?: any) {
         ...
         * @throws {RequiredError}
         */
        marketLookupLocation(query?: string, xAmphoradataVersion?: string, options?: any) {
...
export class MarketApi extends BaseAPI {
     ...
     * @memberof MarketApi
     */
    public marketFind(query?: string, top?: number, skip?: number, xAmphoradataVersion?: string, options?: any) {
     ...
     * @memberof MarketApi
     */
    public marketLookupLocation(query?: string, xAmphoradataVersion?: string, options?: any) {
...
export const OrganisationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        termsAndConditionsCreate(id: string, termsAndConditions: TermsAndConditions, xAmphoradataVersion?: string, options: any = {}): RequestArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling termsAndConditionsCreate.');
            }
            ...
            if (termsAndConditions === null || termsAndConditions === undefined) {
                throw new RequiredError('termsAndConditions','Required parameter termsAndConditions was null or undefined when calling termsAndConditionsCreate.');
            }
            const localVarPath = `/api/Organisations/{id}/TermsAndConditions`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...options.headers};
            const needsSerialization = (typeof termsAndConditions !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
         ...
         * @throws {RequiredError}
         */
        termsAndConditionsRead(id: string, xAmphoradataVersion?: string, options: any = {}): RequestArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling termsAndConditionsRead.');
            }
            const localVarPath = `/api/Organisations/{id}/TermsAndConditions`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const OrganisationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        termsAndConditionsCreate(id: string, termsAndConditions: TermsAndConditions, xAmphoradataVersion?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TermsAndConditions> {
            const localVarAxiosArgs = OrganisationsApiAxiosParamCreator(configuration).termsAndConditionsCreate(id, termsAndConditions, xAmphoradataVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        termsAndConditionsRead(id: string, xAmphoradataVersion?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TermsAndConditions>> {
            const localVarAxiosArgs = OrganisationsApiAxiosParamCreator(configuration).termsAndConditionsRead(id, xAmphoradataVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OrganisationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        termsAndConditionsCreate(id: string, termsAndConditions: TermsAndConditions, xAmphoradataVersion?: string, options?: any) {
         ...
         * @throws {RequiredError}
         */
        termsAndConditionsRead(id: string, xAmphoradataVersion?: string, options?: any) {
...
export class OrganisationsApi extends BaseAPI {
     ...
     * @memberof OrganisationsApi
     */
    public termsAndConditionsCreate(id: string, termsAndConditions: TermsAndConditions, xAmphoradataVersion?: string, options?: any) {
     ...
     * @memberof OrganisationsApi
     */
    public termsAndConditionsRead(id: string, xAmphoradataVersion?: string, options?: any) {
