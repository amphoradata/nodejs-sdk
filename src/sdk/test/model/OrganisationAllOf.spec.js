...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amphoradata.OrganisationAllOf();
  });
  ...
  describe('OrganisationAllOf', function() {
    it('should create an instance of OrganisationAllOf', function() {
      // uncomment below and update the code to test OrganisationAllOf
      //var instane = new Amphoradata.OrganisationAllOf();
      //expect(instance).to.be.a(Amphoradata.OrganisationAllOf);
    });
