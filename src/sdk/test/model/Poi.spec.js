...
(function(root, factory) {
  ...
  describe('Poi', function() {
    it('should create an instance of Poi', function() {
      ...
      //var instane = new Amphoradata.Poi();
      //expect(instance).to.be.a(Amphoradata.Poi);
    });
    ...
    it('should have the property categorySet (base name: "categorySet")', function() {
      // uncomment below and update the code to test the property categorySet
      //var instane = new Amphoradata.Poi();
      //expect(instance).to.be();
    });
