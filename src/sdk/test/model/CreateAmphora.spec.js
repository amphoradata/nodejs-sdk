...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amphoradata.CreateAmphora();
  });
  ...
  describe('CreateAmphora', function() {
    it('should create an instance of CreateAmphora', function() {
      // uncomment below and update the code to test CreateAmphora
      //var instane = new Amphoradata.CreateAmphora();
      //expect(instance).to.be.a(Amphoradata.CreateAmphora);
    });
