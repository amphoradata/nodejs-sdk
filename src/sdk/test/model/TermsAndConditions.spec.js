...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amphoradata.TermsAndConditions();
  });
  ...
  describe('TermsAndConditions', function() {
    it('should create an instance of TermsAndConditions', function() {
      // uncomment below and update the code to test TermsAndConditions
      //var instane = new Amphoradata.TermsAndConditions();
      //expect(instance).to.be.a(Amphoradata.TermsAndConditions);
    });
