...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amphoradata.PlanInformation();
  });
  ...
  describe('PlanInformation', function() {
    it('should create an instance of PlanInformation', function() {
      // uncomment below and update the code to test PlanInformation
      //var instane = new Amphoradata.PlanInformation();
      //expect(instance).to.be.a(Amphoradata.PlanInformation);
    });
