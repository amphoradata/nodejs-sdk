...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amphoradata.BaseAmphoraUser();
  });
  ...
  describe('BaseAmphoraUser', function() {
    it('should create an instance of BaseAmphoraUser', function() {
      // uncomment below and update the code to test BaseAmphoraUser
      //var instane = new Amphoradata.BaseAmphoraUser();
      //expect(instance).to.be.a(Amphoradata.BaseAmphoraUser);
    });
