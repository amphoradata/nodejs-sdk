...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amphoradata.AmphoraUser();
  });
  ...
  describe('AmphoraUser', function() {
    it('should create an instance of AmphoraUser', function() {
      // uncomment below and update the code to test AmphoraUser
      //var instane = new Amphoradata.AmphoraUser();
      //expect(instance).to.be.a(Amphoradata.AmphoraUser);
    });
