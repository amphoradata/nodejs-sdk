...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amphoradata.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    ...
    describe('usersReadSelf', function() {
      it('should call usersReadSelf successfully', function(done) {
        //uncomment below and update the code to test usersReadSelf
        //instance.usersReadSelf(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
